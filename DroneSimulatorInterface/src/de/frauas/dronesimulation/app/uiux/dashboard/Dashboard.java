...
public class Dashboard extends JFrame {
	...
	public Dashboard(ApiHandler droneApiHandler, List<DroneList> listOfDrones, List<DroneType> listOfDroneTypes, List<DroneDynamics> listOfDronesDynamicTimeStamp) {
		...
		JLabel droneInfos_lbl1 = new JLabel("Model: ");
		...
		JLabel droneInfos_lbl2 = new JLabel("Serial Number:");
		...
		JLabel droneInfos_lbl3 = new JLabel("Weight: ");
		...
		JLabel droneInfos_lbl4 = new JLabel("Max Speed: ");
		...
		JLabel droneInfos_lbl5 = new JLabel("Carriage type: ");
		...
		JLabel droneInfos_lbl6 = new JLabel("Battery Capacity: ");
		...
		JLabel droneInfos_lbl7 = new JLabel("Carriage weight: ");
		...
		JLabel droneInfos_lbl8 = new JLabel("Max Carriage weight: ");
		...
		JLabel droneSpeed_Icon = new JLabel("");
		...
		JLabel droneBattery_Icon = new JLabel("");
		...
		JLabel droneStatus_Icon = new JLabel("");
		...
		JLabel drone_Icon_Extra = new JLabel("");
		...
		JLabel droneID = new JLabel("#1 Altair Aerial ID: 72");
		...
		JLabel dynamicInfos_lbl1 = new JLabel("Speed: ");
		...
		JLabel dynamicInfos_lbl2 = new JLabel("Serial Number: ");
		...
		JLabel dynamicInfos_lbl3 = new JLabel("Align Roll: ");
		...
		JLabel dynamicInfos_lbl4 = new JLabel("Align Pitch: ");
		...
		JLabel dynamicInfos_lbl5 = new JLabel("Align Yaw: ");
		...
		JLabel dynamicInfos_lbl6 = new JLabel("Longitude: ");
		...
		JLabel dynamicInfos_lbl7 = new JLabel("Last Seen: ");
		...
		JLabel dynamicInfos_lbl8 = new JLabel("Status: ");
			...
			public void mouseClicked(MouseEvent e) {
				...
				for (DroneList drone : listOfDrones) {
					if (model.getValueAt(index, 0).equals(drone.getId())) {
						...
						fetchDroneDetails( index, drone, droneID, batteryPercentage, droneInfos_lbl1, droneInfos_lbl2, droneInfos_lbl3, droneInfos_lbl4, droneInfos_lbl5, droneInfos_lbl6, droneInfos_lbl7, droneInfos_lbl8,
								dynamicInfos_lbl1, dynamicInfos_lbl2, dynamicInfos_lbl3, dynamicInfos_lbl4, dynamicInfos_lbl5, dynamicInfos_lbl6, dynamicInfos_lbl7, dynamicInfos_lbl8 );
	...
	////////////////////////////////////////////////////////////////////////////
	private static void fetchDroneDetails( int i, DroneList drone, JLabel droneID, int batteryPercentage, JLabel droneInfos_lbl1, JLabel droneInfos_lbl2, JLabel droneInfos_lbl3, JLabel droneInfos_lbl5,
			JLabel droneInfos_lbl4, JLabel droneInfos_lbl6, JLabel droneInfos_lbl7, JLabel droneInfos_lbl8,
			JLabel dynamicInfos_lbl1, JLabel dynamicInfos_lbl2, JLabel dynamicInfos_lbl3, JLabel dynamicInfos_lbl4, JLabel dynamicInfos_lbl5,
			JLabel dynamicInfos_lbl6, JLabel dynamicInfos_lbl8, JLabel dynamicInfos_lbl7) {
		try {
			...
			LOG.severe("An error occurred while detching Drone Details. " + e.getMessage());
			e.printStackTrace();
			System.exit(1); // stop the application
		}
